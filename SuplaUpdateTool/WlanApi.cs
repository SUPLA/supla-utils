...
namespace NativeWifi
{
	...
	public class WlanClient
	{
		...
		public class WlanInterface
		{
			...
			/// The method returns immediately. Progress is reported through the <see cref="WlanNotification"/> event.
			/// </remarks>
			public void Connect(Wlan.WlanConnectionMode connectionMode, Wlan.Dot11BssType bssType, IntPtr dot11SsidPtr, string profile)
			{
			...
			/// <returns></returns>
			public bool ConnectSynchronously(Wlan.WlanConnectionMode connectionMode, Wlan.Dot11BssType bssType, IntPtr dot11SsidPtr, string profile, int connectTimeout)
			{
				queueEvents = true;
				try
				{
					Connect(connectionMode, bssType, dot11SsidPtr, profile);
            ...
            /// <summary>
            /// The Disconnect function disconnects an interface from its current network.
            /// </summary>
